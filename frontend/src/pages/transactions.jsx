  ...
  return (
    <>
      <div className='w-full py-10'>
        <div className='flex flex-col md:flex-row md:items-center justify-between mg-10'>
          ...
          <div className='flex flex-col md:flex-row md:items-center gap-4'>
            ...
            <form onSubmit={(e) => handleSearch(e)}>
              <div className='w-full flex items-center gap-2 border border-gray-300 dark:border-gray-600 rounded-md px-2 py-2'>
                ...
                <input
                  ...
                  className='outline-none bg-transparent text-gray-700 dark:text-gray-400 placeholder:text-gray-600'
                />
              </div>
            </form>
            ...
            <button
              ...
              className='py-1.5 px-2 rounded text-white bg-black dark:bg-violet-800 flex items-center justify-center gap-2 border'
            >
              <MdAdd size={22} />
              <span>Pay</span>
            </button>
                ...
                {data?.map((item, index) => (
                  ...
                  >
                    ...
                    <td className='py-4 text-black dark:text-gray-400 text-base font-medium'>
                      <span
                        className={`$${item?.type === "income" ? "text-emerald-600" : "text-red-600"} text-lg font-bold mgl-1`}
                      >
                        {item?.type === "income" ? "+" : "-"}
                      </span>
